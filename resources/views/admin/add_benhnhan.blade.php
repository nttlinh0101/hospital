...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 style="text-align: center; font-size: 25px;" class="card-title">Thêm Bệnh Nhân Mới</h5>
                                <?php 
                                 ...
                                 ?>
                                <form role="form" action="{{URL::to('/save-benhnhan')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                <div class="form-group row">
                                        <label for="fname" class="col-md-3 m-t-15">Tên</label>
                                        <div class="col-sm-9">
                                            <input data-validation="length" data-validation-length="min3" data-validation-error-msg="nhập sai" required name="TenBN" type="text" class="form-control" id="fname" placeholder="Nhập Tên">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                 ...
                                 {{-- <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-md-3 m-t-15">CMND</label>
                                        <div class="col-sm-9">
                                            <input required name="CMND" type="text" class="form-control" id="lname" placeholder="Nhập số CMND">
                                        </div>
                                    </div>
                                <div class="form-group row">
                                    <label class="col-md-3 m-t-15">Mã tài khoản</label>
                                    <div class="col-md-9">
                                        {{-- <select required id="khoa" name="MaTK" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                            <option></option>
                                             @foreach ($ds_TaiKhoan as $key => $value)
                                                <option value="{{$value->MaTK}}">{{$value->Ten}}</option>
                                            @endforeach
                                        </select> --}}
                                        <input required name="MaTK" type="text" class="form-control" id="lname" placeholder="Nhập TK">
                                    </div>
                                </div>
